...
raster::cellStats(pred_surveyed, sum) #565 ind
...
raster::cellStats(pred_region, sum) #1093 ind
...
cor(obs, pred, method = 'spearman', use = "everything") #0.11
...
cor(na.omit(as.vector(abundance_dugong2_strat1)), na.omit(as.vector(pred_surveyed_for_comp2_strat1))) # 0.45
cor(na.omit(as.vector(abundance_dugong2_strat2)), na.omit(as.vector(pred_surveyed_for_comp2_strat2))) # 0.33
...
mean(na.omit(as.vector(abundance_dugong2_strat1)) / na.omit(as.vector(pred_surveyed_for_comp2_strat1))) # 0.70
mean(na.omit(as.vector(abundance_dugong2_strat2)) / na.omit(as.vector(pred_surveyed_for_comp2_strat2))) # 0.81
mean(na.omit(as.vector(abundance_dugong2_strat3)) / na.omit(as.vector(pred_surveyed_for_comp2_strat3))) # 0.72
...
#calculate spearman coef per strata
cor(na.omit(as.vector(abundance_dugong2_strat1)), na.omit(as.vector(pred_surveyed_for_comp2_strat1))) # 0.95
cor(na.omit(as.vector(abundance_dugong2_strat2)), na.omit(as.vector(pred_surveyed_for_comp2_strat2))) # 0.85
cor(na.omit(as.vector(abundance_dugong2_strat3)), na.omit(as.vector(pred_surveyed_for_comp2_strat3))) # 0.68
...
raster::cellStats(pred_region_interp, sum) #1051 ind
