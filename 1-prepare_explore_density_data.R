...
levels(telemetry_obs$object)[levels(telemetry_obs$object) %in% c("Dugong_certain", "Dugong_probable")] <- "Dugong_certain_probable"
...
#write
raster::writeRaster(r_density_dugong[[8]], here::here("data", "processed_data", "density", "dugong_density.grd"), overwrite=TRUE)


#tO do 
#correct availability bias in density
#extract off effort portions
